...
urlpatterns = [
    ...
    path(
        "delete_course/<str:course_id>/", HodViews.delete_course, name="delete_course"
    ),
    ...
    path(
        "student_leave_approve/<str:leave_id>/",
        HodViews.student_leave_approve,
        name="student_leave_approve",
    ),
    path(
        "student_leave_reject/<str:leave_id>/",
    ...
    path(
        "staff_leave_approve/<str:leave_id>/",
        HodViews.staff_leave_approve,
        name="staff_leave_approve",
    ),
    path(
        "staff_leave_reject/<str:leave_id>/",
        HodViews.staff_leave_reject,
    ...
    path("manage_passwords/", HodViews.manage_passwords, name="manage_passwords"),
    path("reset_password/", HodViews.reset_password, name="reset_password"),
    path(
        "change_own_password/", HodViews.change_own_password, name="change_own_password"
    ),
    path(
        "delete_incomplete_student/<str:user_id>",
        HodViews.delete_incomplete_student,
        name="delete_incomplete_student",
    ),
    path(
        "delete_incomplete_staff/<str:user_id>",
        HodViews.delete_incomplete_staff,
        name="delete_incomplete_staff",
    ),
    # URLS for Staff
    ...
    path(
        "manage_assignments/",
        StaffViews.manage_assignments,
        name="staff_manage_assignments",
    ),
    path("add_assignment/", StaffViews.add_assignment, name="staff_add_assignment"),
    path(
        "add_assignment_save/",
        StaffViews.add_assignment_save,
        name="staff_add_assignment_save",
    ),
    path(
        "delete_assignment/<int:assignment_id>/",
        StaffViews.delete_assignment,
        name="staff_delete_assignment",
    ),
    path(
        "view_assignment_submissions/<int:assignment_id>/",
        StaffViews.view_assignment_submissions,
        name="staff_view_submissions",
    ),
    path(
        "grade_assignment/<int:submission_id>/",
        StaffViews.grade_assignment,
        name="ajax_grade_assignment",
    ),
    # Fine Management URLs
    path("manage_fines/", StaffViews.manage_fines, name="manage_fines"),
    path("add_fine/", StaffViews.add_fine, name="add_fine"),
    path("add_fine_save/", StaffViews.add_fine_save, name="add_fine_save"),
    path("delete_fine/<int:fine_id>/", StaffViews.delete_fine, name="delete_fine"),
    path(
        "student_view_fines/",
        StudentViews.student_view_fines,
        name="student_view_fines",
    ),
    path(
        "student/initialize_payment/<int:fine_id>/",
        StudentViews.initialize_payment,
        name="initialize_payment",
    ),
    path(
        "student/payment_callback/",
